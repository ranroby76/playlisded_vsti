/*
  ==============================================================================
    ...
    - ADDED: Graceful quit command before kill.
...
void AudioEngine::timerCallback()
{
    ...
    else 
    {
        ...
        // Send heartbeat to engine so it knows we're alive
        sendHeartbeat();
    }
}
...
{
    // RESTORED: Original buffer allocation
    ...
    // RESTORED: Critical - flush buffer to prevent ghost audio
    if (ipc.isConnected())
    {
...
{
    // RESTORED: Original audio processing logic
    const int numSamples = buffer.getNumSamples();
